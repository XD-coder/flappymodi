...
const HEIGHT = 92;
const WIDTH = 64;
const FRAMES = ["0px", "64px", "128px", "0px"];
const defaultState = {
  bird: {
    position: { x: 0, y: 0 },
...
export const GameProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  // audio controls live here (not part of the immer game state)
  ...
  return (
    <GameContext.Provider
      value={{
        ...state,
        audioVolume,
        setAudioVolume: (v: number) => setAudioVolume(v),
        audioMuted,
        toggleAudioMuted: () => setAudioMuted((s) => !s),
        getNextFrame,
        fall,
        fly,
        handleWindowClick,
